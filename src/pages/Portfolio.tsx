          ...
          <CardContent className="p-8">
            <div className="flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-8">
              ...
              <div className="text-center md:text-left">
                <h2 className="text-3xl font-bold text-gray-900 mb-2">Jaya Teacher</h2>
                <p className="text-xl text-blue-600 mb-4">Senior Educator & Tutorial Specialist</p>
                <p className="text-gray-600 leading-relaxed">
                  With over 10 years of experience in education, I am passionate about helping students 
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                <Badge variant="secondary">M.Ed</Badge>
                <span>Master of Education - University of Excellence (2015)</span>
              </div>
              <div className="flex items-center space-x-3">
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <h4 className="font-semibold mb-2">Morning Batches</h4>
